...
def findEncodings():
    for image in os.listdir('C:/Coding/Personal Project (Face Detection)/FaceRecog_Project_Attendance System/Student DataBase'):
        face_image = face_recognition.load_image_file(f'C:/Coding/Personal Project (Face Detection)/FaceRecog_Project_Attendance System/Student DataBase/{image}')
